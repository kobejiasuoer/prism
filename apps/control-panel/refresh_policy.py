...
TASK_POLICIES: dict[str, TaskPolicy] = {
    ...
    "formal_data_refresh": TaskPolicy(
        task_name="formal_data_refresh",
        title="正式口径数据刷新",
        kind="maintenance",
        cooldown_seconds=30 * 60,
        auto_windows=("standby",),
        ...
        auto_enabled=False,
        same_family="formal_data",
    ),
    "formal_data_refresh_postclose": TaskPolicy(
        task_name="formal_data_refresh_postclose",
        title="正式日线复权盘后补齐",
        kind="maintenance",
        cooldown_seconds=30 * 60,
        auto_windows=("postclose",),
        manifest_dependencies=("bars.daily", "adjustment.factor"),
        auto_enabled=False,
        fixed_cron_only=True,
        same_family="formal_data",
    ),
    "formal_data_refresh_index_morning": TaskPolicy(
        task_name="formal_data_refresh_index_morning",
        title="正式基准指数补刷-上午一",
        kind="maintenance",
        cooldown_seconds=30 * 60,
        auto_windows=("standby",),
        manifest_dependencies=("benchmark.index_daily",),
        auto_enabled=False,
        fixed_cron_only=True,
        same_family="formal_data",
    ),
    "formal_data_refresh_index_late_morning": TaskPolicy(
        task_name="formal_data_refresh_index_late_morning",
        title="正式基准指数补刷-上午二",
        kind="maintenance",
        cooldown_seconds=30 * 60,
        auto_windows=("standby",),
    ...
    "formal_data_refresh_index_postclose": TaskPolicy(
        task_name="formal_data_refresh_index_postclose",
        title="正式基准指数补刷-收盘一",
        kind="maintenance",
        cooldown_seconds=30 * 60,
        auto_windows=("postclose",),
    ...
    "formal_data_refresh_index_postclose_second": TaskPolicy(
        task_name="formal_data_refresh_index_postclose_second",
        title="正式基准指数补刷-收盘二",
        kind="maintenance",
        cooldown_seconds=30 * 60,
        auto_windows=("postclose",),
    ...
    "formal_data_refresh_index_postclose_third": TaskPolicy(
        task_name="formal_data_refresh_index_postclose_third",
        title="正式基准指数补刷-收盘三",
        kind="maintenance",
        cooldown_seconds=30 * 60,
        auto_windows=("postclose",),
    ...
    "formal_data_refresh_index_postclose_fourth": TaskPolicy(
        task_name="formal_data_refresh_index_postclose_fourth",
        title="正式基准指数补刷-收盘四",
        kind="maintenance",
        cooldown_seconds=30 * 60,
        auto_windows=("postclose",),
...
CRON_POLICIES: tuple[CronJobPolicy, ...] = (
    ...
    CronJobPolicy(
        ...
        name="正式日线复权盘后补齐",
        cron_expr="35 16 * * 1-5",
        command=("python3", "apps/scripts/refresh_formal_data.py", "--datasets", "bars.daily,adjustment.factor"),
        delivery_default=False,
        catchup_enabled=True,
        catchup_until="17:20",
        retry_attempts=2,
    ...
    CronJobPolicy(
        ...
        name="正式基准指数补刷-上午一",
        cron_expr="37 10 * * 1-5",
        command=("python3", "apps/scripts/refresh_formal_data.py", "--datasets", "benchmark.index_daily"),
        delivery_default=False,
        catchup_enabled=True,
        catchup_until="11:20",
    ),
    ...
    CronJobPolicy(
        ...
        catchup_enabled=True,
        catchup_until="15:05",
        depends_on=("midday_confirmation",),
    ),
    CronJobPolicy(
        task_name="postclose_command_brief",
        name="收盘后总控简报",
