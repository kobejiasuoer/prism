...
DATASET_REGISTRY: dict[str, DatasetDefinition] = {
    ...
    "capital_flow.daily": DatasetDefinition(
        ...
        fallback_providers=["eastmoney", "ths"],
        ttl_intraday=600,
        ttl_post_close=86400,
        required_for_live_small=True,
        source_lane="live",
    ...
    "valuation.daily": DatasetDefinition(
        name="valuation.daily",
        description="Daily valuation factors from official-style end-of-day sources",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "liquidity.daily": DatasetDefinition(
        name="liquidity.daily",
        description="Daily liquidity and share-float factors",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "financial.indicator": DatasetDefinition(
        name="financial.indicator",
        description="Per-stock financial indicator history",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "financial.statement": DatasetDefinition(
        name="financial.statement",
        description="Per-stock income, balance sheet, cashflow, express, and forecast statement bundle",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "corporate_action.dividend": DatasetDefinition(
    ...
    "shareholder.top10": DatasetDefinition(
        name="shareholder.top10",
        description="Top ten shareholders and float shareholders history",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.limit_events": DatasetDefinition(
        name="market.limit_events",
        description="Daily limit-up/limit-down event details",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "index.weight": DatasetDefinition(
        name="index.weight",
        description="Official-style index constituent weights",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.daily_basic_snapshot": DatasetDefinition(
        name="market.daily_basic_snapshot",
        description="Whole-market daily basic valuation snapshot",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.margin": DatasetDefinition(
        name="market.margin",
        description="Margin financing and securities lending market totals",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.top_list": DatasetDefinition(
        name="market.top_list",
        description="Dragon-Tiger list stock activity",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.top_inst": DatasetDefinition(
        name="market.top_inst",
        description="Dragon-Tiger institutional seat detail",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.hsgt_moneyflow": DatasetDefinition(
        name="market.hsgt_moneyflow",
        description="Northbound and southbound money flow summary",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.ggt_daily": DatasetDefinition(
        name="market.ggt_daily",
        description="Hong Kong stock connect daily summary",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "reference.stock_company": DatasetDefinition(
        name="reference.stock_company",
        description="Listed-company profile reference data",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "reference.namechange": DatasetDefinition(
        name="reference.namechange",
    ...
    "reference.concept": DatasetDefinition(
        name="reference.concept",
        description="Concept taxonomy reference data",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "reference.concept_detail": DatasetDefinition(
        name="reference.concept_detail",
        description="Per-stock concept memberships",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "reference.industry_classify": DatasetDefinition(
        name="reference.industry_classify",
    ...
    "reference.industry_member": DatasetDefinition(
        name="reference.industry_member",
        description="Industry constituent memberships",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "reference.ths_index": DatasetDefinition(
        name="reference.ths_index",
        description="THS sector and concept index taxonomy",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "reference.ths_member": DatasetDefinition(
        name="reference.ths_member",
        description="THS sector and concept index memberships",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "reference.dc_index": DatasetDefinition(
        name="reference.dc_index",
        description="Dongcai sector and concept index taxonomy",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "reference.dc_member": DatasetDefinition(
        name="reference.dc_member",
        description="Dongcai sector and concept memberships",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "financial.main_business": DatasetDefinition(
        name="financial.main_business",
        description="Main business composition by product, region, and industry",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.margin_detail": DatasetDefinition(
        name="market.margin_detail",
        description="Per-stock margin financing and securities lending details",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.margin_secs": DatasetDefinition(
        name="market.margin_secs",
        description="Marginable securities list and attributes",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.block_trade": DatasetDefinition(
        name="market.block_trade",
        description="Large block-trade records",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.hsgt_top10": DatasetDefinition(
        name="market.hsgt_top10",
        description="Shanghai/Shenzhen-Hong Kong Stock Connect top traded securities",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "market.ggt_top10": DatasetDefinition(
        name="market.ggt_top10",
        description="Hong Kong Stock Connect top traded securities",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "corporate_action.pledge_stat": DatasetDefinition(
        name="corporate_action.pledge_stat",
        description="Equity pledge statistics",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "corporate_action.pledge_detail": DatasetDefinition(
        name="corporate_action.pledge_detail",
        description="Equity pledge detail records",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "corporate_action.share_float": DatasetDefinition(
        name="corporate_action.share_float",
        description="Restricted-share unlock records",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "corporate_action.repurchase": DatasetDefinition(
        name="corporate_action.repurchase",
        description="Share repurchase announcements and progress",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "financial.audit": DatasetDefinition(
        name="financial.audit",
        description="Financial statement audit opinions",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "research.report_rc": DatasetDefinition(
        name="research.report_rc",
        description="Research report consensus and rating records",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "technical.stk_factor": DatasetDefinition(
        name="technical.stk_factor",
        description="Technical factor history",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "technical.cyq_perf": DatasetDefinition(
        name="technical.cyq_perf",
        description="Chip distribution performance indicators",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "technical.cyq_chips": DatasetDefinition(
        name="technical.cyq_chips",
        description="Chip distribution detail history",
        primary_provider="tushare",
        fallback_providers=[],
        ttl_intraday=86400,
        ttl_post_close=86400,
    ...
    "execution.flags": DatasetDefinition(
        ...
        description="Execution availability flags from daily limit, suspend/resume, and ST status",
        primary_provider="tushare",
        fallback_providers=["ricequant", "joinquant"],
        ttl_intraday=86400,
        ttl_post_close=86400,
        required_for_live_small=False,
        source_lane="execution",
...
def _authority_metadata(
    *,
    ...
    authority_override = str(result_extra.get("authority_provider_override") or "").strip()
    if authority_override and provider == authority_override and authority_override == target_authority:
        configured_authority = authority_override
